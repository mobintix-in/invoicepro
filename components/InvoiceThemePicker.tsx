...
export const TEMPLATES: InvoiceTemplateOption[] = [
  {
    ...
    tag: "Standard / Tally",
    description:
      "Statutory Indian GST format with full grid borders, formal consignee box, and HSN breakdown.",
    icon: (color: string) => (
      <svg
        viewBox="0 0 100 70"
        className="w-full h-14 rounded border border-gray-200 bg-white p-1 shadow-xs"
      >
        <rect
          x="4"
          y="4"
  ...
  },
  {
    ...
    tag: "Clean & Sleek",
    description:
      "Borderless contemporary layout with generous typography, soft dividers, and floating payment card.",
    icon: (color: string) => (
      <svg
        viewBox="0 0 100 70"
        className="w-full h-14 rounded border border-gray-200 bg-white p-1 shadow-xs"
  ...
  },
  {
    ...
    tag: "Bold & Premium",
    description:
      "Header colored banner with high contrast, elegant client cards, and high-impact totals summary.",
    icon: (color: string) => (
      <svg
        viewBox="0 0 100 70"
        className="w-full h-14 rounded border border-gray-200 bg-white p-0 shadow-xs overflow-hidden"
      >
  ...
  },
  {
    ...
    description:
      "Space-optimized ledger design with clear horizontal dividers, engineered for multi-item invoices.",
    icon: (color: string) => (
      <svg
        viewBox="0 0 100 70"
        className="w-full h-14 rounded border border-gray-200 bg-white p-1 shadow-xs"
...
export default function InvoiceThemePicker({
  ...
  const activeColor =
    THEMES.find((t) => t.key === selectedTheme)?.color || "#4F46E5";
