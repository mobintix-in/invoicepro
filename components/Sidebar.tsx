...
const ICON = {
  ...
  measurements: 'M4.5 3.75h15v16.5h-15V3.75zm3 0v3m3-3v2m3-2v3m3-3v2M4.5 9h4.125M4.5 12h2.625M4.5 15h4.125M4.5 18h2.625',
...
export default function Sidebar() {
  ...
  const links = [
    ...
    { name: 'Fabric Production', path: '/measurements', icon: ICON.measurements },
