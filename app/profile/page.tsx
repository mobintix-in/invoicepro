    ...
    <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Your business details here auto-fill the "From" side of every new
          invoice.
        </p>
      </div>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <Section
          ...
          hint={"Shown as the seller (\u201cFrom\u201d) on your invoices."}
        >
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="sm:col-span-2">
            ...
            <div>
              <label htmlFor="stateName" className={labelCls}>
                State Name
              </label>
              <input
                id="stateName"
            ...
            <div>
              <label htmlFor="stateCode" className={labelCls}>
                State Code
              </label>
              <input
                id="stateCode"
        ...
        <Section
          ...
          hint="Appears on invoices for payment. Add your UPI ID to auto-generate a QR code in the PDF."
        >
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="bankAccountName" className={labelCls}>
                A/c Holder Name
              </label>
              <input
                id="bankAccountName"
            ...
            <div>
              <label htmlFor="ifscCode" className={labelCls}>
                IFSC Code
              </label>
              <input
                id="ifscCode"
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-gray-400">
                A scannable UPI QR code will appear in the payment section of
                every PDF you generate.
              </p>
            </div>
          </div>
        </Section>
        ...
        >
          <div>
            <label htmlFor="defaultInvoiceNotes" className={labelCls}>
            ...
            <p className="mt-1.5 text-xs text-gray-400">
              You can still change or remove these notes on an individual
              invoice.
            </p>
          </div>
        </Section>
